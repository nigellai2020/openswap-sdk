...
const OSWAP_RestrictedLiquidityProvider4_json_1 = __importDefault(require("./OSWAP_RestrictedLiquidityProvider4.json"));
class OSWAP_RestrictedLiquidityProvider4 extends eth_contract_1.Contract {
