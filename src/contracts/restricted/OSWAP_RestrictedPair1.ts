...
import Bin from "./OSWAP_RestrictedPair1.json";
...
export class OSWAP_RestrictedPair1 extends Contract{
    ...
    removeAllLiquidity: {
        ...
        call: (provider:string, options?: TransactionOptions) => Promise<{amount0:BigNumber,amount1:BigNumber}>;
    }
    removeAllLiquidity1D: {
        (params: IRemoveAllLiquidity1DParams, options?: TransactionOptions): Promise<TransactionReceipt>;
        call: (params: IRemoveAllLiquidity1DParams, options?: TransactionOptions) => Promise<{totalAmount:BigNumber,totalReceiving:BigNumber}>;
    }
    removeLiquidity: {
    ...
    private assign(){
        ...
        let addLiquidityParams = (params: IAddLiquidityParams) => [params.direction,this.wallet.utils.toString(params.index)];
        ...
        let removeAllLiquidity_call = async (provider:string, options?: TransactionOptions): Promise<{amount0:BigNumber,amount1:BigNumber}> => {
        ...
        let removeAllLiquidity1D_call = async (params: IRemoveAllLiquidity1DParams, options?: TransactionOptions): Promise<{totalAmount:BigNumber,totalReceiving:BigNumber}> => {
        ...
        let removeLiquidityParams = (params: IRemoveLiquidityParams) => [params.provider,params.direction,this.wallet.utils.toString(params.index),this.wallet.utils.toString(params.amountOut),this.wallet.utils.toString(params.receivingOut)];
        ...
        let setApprovedTraderParams = (params: ISetApprovedTraderParams) => [params.direction,this.wallet.utils.toString(params.offerIndex),params.trader,this.wallet.utils.toString(params.allocation)];
        let setApprovedTrader_send = async (params: ISetApprovedTraderParams, options?: TransactionOptions): Promise<TransactionReceipt> => {
            let result = await this.send('setApprovedTrader',setApprovedTraderParams(params),options);
            return result;
        }
        let setApprovedTrader_call = async (params: ISetApprovedTraderParams, options?: TransactionOptions): Promise<void> => {
        ...
        let setMultipleApprovedTradersParams = (params: ISetMultipleApprovedTradersParams) => [params.direction,this.wallet.utils.toString(params.offerIndex),params.trader,this.wallet.utils.toString(params.allocation)];
        let setMultipleApprovedTraders_send = async (params: ISetMultipleApprovedTradersParams, options?: TransactionOptions): Promise<TransactionReceipt> => {
            let result = await this.send('setMultipleApprovedTraders',setMultipleApprovedTradersParams(params),options);
            return result;
        }
        let setMultipleApprovedTraders_call = async (params: ISetMultipleApprovedTradersParams, options?: TransactionOptions): Promise<void> => {
